...
SIFT = True
left = Image.open("left.jpg").convert("L").convert("F")
right = Image.open("right.jpg").convert("L").convert("F")
...
threshold = 10000
if(SIFT):
    left = cv2.cvtColor(cv2.imread("left.jpg"), cv2.COLOR_RGB2GRAY)
    right = cv2.cvtColor(cv2.imread("right.jpg"), cv2.COLOR_RGB2GRAY)
